...
export const personalInfo = {
  ...
  philosophy: {
    ...
    secondary:
      "Passionate about bridging the gap between theoretical computer science and real-world applications. Every algorithm tells a story, every project solves a problem, and every line of code brings ideas to life.",
    values: [
  ...
  bio: {
    short:
      "A passionate B.Tech Computer Science student from Chitkara University (2022–2026), combining full-stack development skills with strong computer science fundamentals.",
    detailed:
      "I excel in problem-solving through programming, having solved 250+ DSA problems in Java and C++, while also building modern web applications with React, Node.js, and databases. My approach bridges theoretical CS knowledge with practical software development experience.",
  },
  university: {
...
export const csTopics = [
  ...
  },
  {
    ...
    description:
      "Deep understanding of system-level programming and OS concepts",
    stats: {
      //projects: "5+",
      // languages: "C, C++",
...
export const projects: Project[] = [
  // Full Stack / Major Projects
  {
    ...
    description:
      "Full-stack seller dashboard for managing e-commerce products, inventory, orders, and analytics with secure authentication.",
    images: [
    ...
    liveUrl: null,
    githubUrl: "https://github.com/RudrakshTaya/Ecommerce-sellerDashboard",
    featured: true,
    stats: { stars: 1, forks: 0, views: 150 },
    highlights: [
  ...
  {
    id: 2,
    title: "BuiltByRudraksh Portfolio Website",
    description:
      "Personal portfolio website showcasing projects, skills, and achievements, built with modern frontend frameworks.",
    images: [
      "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&h=400",
    ],
    category: "Frontend",
    type: "Minor",
    tech: ["React", "TypeScript", "TailwindCSS"],
    languages: ["TypeScript"],
    liveUrl: "https://builtbyrudraksh.onrender.com",
    githubUrl: "https://github.com/RudrakshTaya/BuiltByRudraksh",
    featured: true,
  ...
  // Backend Projects
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=400",
    ],
    category: "Backend",
    type: "Minor",
    ...
    liveUrl: null,
    githubUrl: "https://github.com/RudrakshTaya/bfhl-api",
    featured: false,
  ...
  // Frontend / Learning Projects
  {
    ...
    description:
      "Frontend clone of Zomato with HTML, CSS, and JavaScript showcasing food delivery UI.",
    images: [
      "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&h=400",
    ],
    category: "Frontend",
    type: "Minor",
    ...
    liveUrl: null,
    githubUrl: "https://github.com/RudrakshTaya/ZomatoProject",
    featured: false,
    stats: { stars: 1, forks: 0, views: 85 },
    highlights: ["UI Design", "Responsive Layout"],
    complexity: "Low",
    duration: "2 weeks",
  },
  {
  ...
  // Python Projects
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=400",
    ],
    category: "Python",
    type: "Major",
    tech: ["Python", "OpenCV"],
    languages: ["Python"],
    liveUrl: null,
    githubUrl: "https://github.com/RudrakshTaya/Face-Recognition-Sytem",
    featured: true,
    stats: { stars: 1, forks: 0, views: 180 },
    highlights: ["Face Detection", "OpenCV Integration"],
    complexity: "Medium",
    duration: "3 weeks",
  },
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=600&h=400",
    ],
    category: "Python",
    type: "Minor",
    tech: ["Python"],
    languages: ["Python"],
    liveUrl: null,
    githubUrl: "https://github.com/RudrakshTaya/Destop_Notifier_using-PYTHON",
    featured: false,
    stats: { stars: 1, forks: 0, views: 60 },
    highlights: ["System Notifications", "Python Scripting"],
    complexity: "Low",
    duration: "1 week",
  },
  {
    ...
    languages: ["Python"],
    liveUrl: null,
    githubUrl: "https://github.com/RudrakshTaya/Voice_Assistance-using-PYTHON",
    featured: false,
    stats: { stars: 1, forks: 0, views: 75 },
    highlights: ["Voice Commands", "Speech Recognition"],
    complexity: "Medium",
    duration: "2 weeks",
  },
];
...
export const projectExperience = [
  {
    ...
    description:
      "Developed a Python-based voice assistant capable of responding to both voice and text inputs. Integrated features like WhatsApp messaging automation using Twilio API, media playback, and mini-games to enhance user engagement.",
    tech: ["Python", "SpeechRecognition", "pyttsx3"],
    achievements: [
  ...
  // },
  {
    ...
    description:
      "Developed a full-stack platform where artists can showcase their work, participate in challenges, and sell art through an integrated e-commerce module. Hosted on AWS with optimized backend APIs and cloud-based media storage.",
  ...
  },
  {
    ...
    learned:
      "Pose estimation, payment integration, real-time systems, high-pressure delivery",
  ...
  pinnedRepos: [
    {
      ...
      forks: 0,
      color: "text-blue-400",
      url: "https://github.com/RudrakshTaya/Ecommerce-sellerDashboard",
    },
    {
      ...
      forks: 0,
      color: "text-blue-400",
      url: "https://github.com/RudrakshTaya/BuiltByRudraksh",
    },
    {
      ...
      url: "https://github.com/RudrakshTaya/flex-it-out-backend",
    },
    {
      ...
      url: "https://github.com/RudrakshTaya/Face-Recognition-Sytem",
    },
    {
      ...
      forks: 0,
      color: "text-yellow-400",
      url: "https://github.com/RudrakshTaya/Ecommerce-Website",
    },
    {
...
export const leetcodeStats = {
  ...
  summary:
    "Solved 196 problems with a 63% acceptance rate. Rated 1847 (Knight), placing in the Top ~6% globally on LeetCode. Active participant in daily challenges and contests with multiple achievement badges.",
};
...
export const achievements = [
  {
    ...
    description:
      "Won first place in the annual university hackathon with an AI-powered student assistant app",
    date: "November 2024",
    icon: "Trophy",
    color: "text-yellow-400",
  ...
  },
  {
    ...
    description:
      "Selected as GDSC Lead for organizing tech events and workshops for 200+ students",
    date: "September 2024",
    icon: "Star",
    color: "text-blue-400",
    category: "Leadership",
  },
  {
    ...
    description:
      "Contributed to 15+ open source projects with 50+ accepted pull requests",
    date: "Ongoing",
    icon: "CheckCircle",
    color: "text-green-400",
  ...
  },
  {
    ...
    description:
      "Achieved Dean's List recognition for academic excellence (Top 5% of class)",
  ...
  },
  {
    ...
    description:
      "Technical articles reached 10K+ reads across Dev.to and Medium platforms",
    date: "December 2024",
    icon: "Target",
    color: "text-cyan-400",
    category: "Writing",
