...
export const projects = [
  // Full Stack Projects
  {
    ...
    description:
      "Complete e-commerce solution with user authentication, product management, shopping cart, payment integration using Stripe, and comprehensive admin dashboard with real-time analytics.",
    images: [
  ...
  },
  {
    ...
    description:
      "Full-stack web application for university student management with course registration, grade tracking, assignment submissions, and comprehensive admin panel built with modern web technologies.",
    images: [
  ...
  // Backend Projects
  {
    ...
    description:
      "Scalable REST API with comprehensive authentication, post management, real-time chat, file uploads, and advanced features like content moderation and analytics.",
    images: [
  ...
  // Java/C++ Projects
  {
    ...
    description:
      "Object-oriented banking system with account management, transaction processing, loan calculations, and comprehensive reporting. Implements all major OOP principles and design patterns.",
    images: [
  ...
  },
  {
    ...
    description:
      "Custom implementation of fundamental data structures including dynamic arrays, linked lists, trees, graphs, and hash tables with comprehensive test suite and documentation.",
    images: [
  ...
  },
  {
    ...
    description:
      "Operating system process scheduling simulator implementing FCFS, SJF, Priority, and Round Robin algorithms with performance metrics and visualization.",
    images: [
  ...
  // Python/CLI Projects
  {
    ...
    description:
      "Command-line tool implementing Huffman coding and LZ77 algorithms for file compression with support for multiple file formats and batch processing capabilities.",
    images: [
      "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=600&h=400&fit=crop",
  ...
  },
  {
    ...
    description:
      "Python CLI tool for fetching, analyzing, and visualizing stock market data with technical indicators, trend analysis, and automated report generation.",
    images: [
  ...
  },
  {
    ...
    description:
      "Advanced network scanning tool with port scanning, vulnerability detection, and network topology mapping capabilities built with Python and Scapy.",
    images: [
      "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=400&fit=crop",
      "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=400&fit=crop",
    ],
  ...
  // Additional Backend Projects
  {
    ...
    description:
      "Distributed chat application using microservices architecture with message queues, real-time communication, and containerized deployment.",
    images: [
