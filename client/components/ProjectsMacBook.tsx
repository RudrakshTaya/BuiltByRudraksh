  ...
  return (
    <div className="relative py-8 sm:py-12">
      ...
      >
        ...
        <div className="relative bg-black rounded-2xl sm:rounded-3xl border-3 sm:border-6 border-gray-800 shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10 p-2 sm:p-4 min-h-[300px] sm:min-h-[400px]">
            ...
            {/* Split screen layout with better heights */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 h-[200px] sm:h-[280px] lg:h-[320px]">
              {/* Terminal Side */}
      ...
      <div className="flex justify-center mt-4 sm:mt-6 gap-2">
        ...
        <div className="flex items-center px-3 py-1 bg-gray-800 text-white rounded text-sm">
