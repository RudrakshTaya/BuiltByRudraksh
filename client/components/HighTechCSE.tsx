...
const DomainCard = ({
  ...
  return (
    ...
    >
      ...
      {isActive && (
        <div
          className={`absolute inset-0 rounded-2xl bg-gradient-to-r from-${domain.color}/20 via-transparent to-${domain.color}/20 blur-xl`}
        />
      )}
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start gap-3 mb-3">
          <div
            className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-${domain.color}/20 flex items-center justify-center border border-${domain.color}/30`}
          >
            <IconComponent
              className={`w-5 h-5 sm:w-6 sm:h-6 text-${domain.color}`}
            />
          </div>
...
export const HighTechCSE = () => {
  ...
  const activeDomainData =
    techDomains.find((d) => d.id === activeDomain) || techDomains[0];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            Exploring cutting-edge computer science domains that are shaping the
        ...
        <motion.div className="glass p-6 sm:p-8 rounded-2xl" layout>
