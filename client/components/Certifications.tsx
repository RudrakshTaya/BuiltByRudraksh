        ...
        >
          <div className="relative h-48 overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
            ...
            <div className="absolute top-4 right-4">
              <span
                className={`${getLevelColor(cert.level)} px-3 py-1 rounded-full text-xs font-bold shadow-lg backdrop-blur-sm`}
              >
                {cert.level}
              </span>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {cert.skills.map((skill) => (
                  <span
                    key={skill}
                    className="bg-blue-600/20 text-blue-300 px-3 py-1 rounded-lg text-xs font-medium border border-blue-500/30"
                  >
                    {skill}
                  </span>
                ))}
        ...
        >
          <div className="glass p-8 rounded-2xl max-w-2xl mx-auto border border-neon-blue/30">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              latest technologies. These certifications represent my dedication
